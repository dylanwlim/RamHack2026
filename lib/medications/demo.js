  ...
  if (entry.id === "demo-vellocet-ir") {
    return {
      ...
      reasoning: [
        ...
        "This remains a simulated medication profile and not FDA-backed evidence.",
      ],
    };
  }
  ...
  return {
    ...
    patient_view: {
      ...
      what_we_know: [
        ...
        "This record is intentionally isolated from FDA-backed medication families.",
      ],
      ...
      unavailable: [
        ...
        "This demo medication does not exist in FDA data.",
      ],
    },
    prescriber_view: {
      headline: signal.label,
...
function buildDemoDrugIntelligencePayload(query) {
  ...
  return {
    ...
    methodology_summary:
      "This is a simulated demo medication profile kept separate from the FDA-backed medication catalog so the demo can show search, strength, and crowd workflows without mislabeling fictional data as real.",
  };
}
